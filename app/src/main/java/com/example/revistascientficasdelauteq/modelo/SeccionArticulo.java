...
public class SeccionArticulo {
    ...
    public SeccionArticulo( String publicationId, String title, String doi, String _abstract, String datePublished, String submissionId, String sectionId, String seq, List<Galey> galeys, List<Keyword> keywords, List<Author> authors) {
    ...
    public SeccionArticulo(JSONObject item) throws JSONException {
    ...
    public static ArrayList<SeccionArticulo> JsonObjectsBuild(JSONArray datos) throws JSONException {
        ArrayList<SeccionArticulo> revistas = new ArrayList<>();
        for (int i = 0; i < datos.length() ; i++) {
            revistas.add(new SeccionArticulo(datos.getJSONObject(i)));
        }
        return revistas;
    }
}
